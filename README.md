...
- **Custom Catalogs**: Import/create your own server collections
...
This starts:
- ✅ MCP Gateway (port 3333) - serves 58+ tools
...
Pre-configured catalogs with production-ready servers:

### production-verified (Recommended)
